...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.buttonNum0.setOnClickListener{numeroPresionado("0")}
        binding.buttonNum1.setOnClickListener{numeroPresionado("1")}
        binding.buttonNum2.setOnClickListener{numeroPresionado("2")}
        binding.buttonNum3.setOnClickListener{numeroPresionado("3")}
        binding.buttonNum4.setOnClickListener{numeroPresionado("4")}
        binding.buttonNum5.setOnClickListener{numeroPresionado("5")}
        binding.buttonNum6.setOnClickListener{numeroPresionado("6")}
        binding.buttonNum7.setOnClickListener{numeroPresionado("7")}
        binding.buttonNum8.setOnClickListener{numeroPresionado("8")}
        binding.buttonNum9.setOnClickListener{numeroPresionado("9")}

        //Botones para las operaciones
        binding.buttonNumSuma.setOnClickListener{operacionPresionado(suma)}
        binding.buttonResta.setOnClickListener{operacionPresionado(resta)}
        binding.buttonMultiplicacion.setOnClickListener{operacionPresionado(multiplicacion)}
        binding.buttonDivision.setOnClickListener{operacionPresionado(division)}

        //Boton para borrar
        binding.buttonClear.setOnClickListener {
            num1 = 0.0;
            num2 = 0.0;
            binding.textResultado.text = "0"
